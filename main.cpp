...
int main(int argc, const char * argv[])
{
    ...
    imwrite("histmap.png", all.histMap);
    //waitKey(0);
    
    char *talkname = "../all/person2label/class1.csv";
    talk.vote(talkname, train);
    char *eatname = "../all/person2label/class2.csv";
    eat.vote(eatname, train);
    char *pcname = "../all/person2label/class3.csv";
    pc.vote(pcname, train);
    char *phonename = "../all/person2label/class4.csv";
    ...
    imwrite("talkSOM6.png",talk.map);
    imwrite("eatSOM6.png", eat.map);
    imwrite("pcSOM6.png",pc.map);
    imwrite("phoneSOM6.png", phone.map);
